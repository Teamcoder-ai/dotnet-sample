...
Minimal ASP.NET Core 8 hello-world used by Splicer's multi-stack vibe-coding
...
Splicer's IT generates a deploy prompt that references a hardcoded ECR image URL.
